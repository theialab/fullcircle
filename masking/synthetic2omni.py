...
out_omni_masks_dir = f"{data_dir}/pre_masking/omni_masks_final"
...
synthetic_masks_paths = sorted(glob.glob(os.path.join(synthetic_masks_dir, "*.png")))

R_lookup = load_R_lookup(R_synthetic)

for fe_path in synthetic_masks_paths:
    ...
    dirs_cam = (R_synthetic.T @ dirs_world.T).T
