    ...
    match name:
        ...
        case "colmap":
            ...
            train_dataset = ColmapDataset(
                ...
                test_frame_suffix=config.dataset.test_frame_suffix,
                ray_jitter=ray_jitter,
                use_border_mask=config.use_border_mask,
                border_mask_path=config.border_mask_train,
            )
            val_dataset = ColmapDataset(
                ...
                test_frame_suffix=config.dataset.test_frame_suffix,
                use_border_mask=config.use_border_mask,
                border_mask_path=config.border_mask_test,
            )
        case "scannetpp":
